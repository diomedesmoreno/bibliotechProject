...
let options = function (data) {
	...
	html += '<div class="dropdown-primary dropdown open">\n' +
		...
		'<a class="dropdown-item" href="'+URL.baseUrl()+'teachers/edit/'+id+'"><i class="ti-pencil-alt"></i> Editar</a>\n'+
		'<a class="dropdown-item waves-light waves-effect delete_dt_item" data-table="#teachers" data-url="'+URL.baseUrl()+'teachers/delete/'+id+'" href="'+URL.baseUrl()+'teachers/delete/'+id+'"><i class="ti-trash"></i> Eliminar</a>\n';
	html +='</div></div>';
