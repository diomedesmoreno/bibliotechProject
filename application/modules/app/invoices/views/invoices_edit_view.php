			...
			<div class="page-wrapper">
				<div class="page-header row">
					<div class="col-md-8 page-header-title">
						<h4>Facturas / #<?php echo $row->number; ?></h4>
						<div>
							<ul class="breadcrumb">
										...
										<div class="row">
											<div class="col-md-7 solid-black">
												...
												<div class="row form-group">
													...
													<div class="col-md-7 alpha">
														<?php echo form_dropdown('parentId', $parents, set_value('parentId',$row->parentId ), "id='parentId' class='form-control select2'");?>
											...
											<div class="col-md-5">
												<div class="row form-group">
													...
													<div class="col-md-7 alpha">
														<?php echo form_dropdown('statusId', $status, set_value('statusId',$row->statusId ), "id='statusId' class='form-control select2'");?>
														<span class="valid-message"></span>
													</div>
												</div>
												<div class="row form-group">
															...
															<table class="table">
																...
																<tbody>
																		...
																		<tr class="row-items">
																			...
																			<td class=""><input type="text" name="quantity[]" class="form-control numeric calculate quantity" data-quantity="0" value="2"></td>
																...
																<?php } else {
																	foreach($table as $key => $item){
																		$select = form_dropdown_data('productId[]', $products, set_value('productId',0 ), "class='form-control productId select2'");
																		$print = '
																		<tr class="row-items">
																			<input type="hidden" name="itemId[]" class="itemId" value="'.$item->itemId.'">
																			<input type="hidden" name="typeId[]" class="typeId" value="'.$item->typeId.'">
																			<td class="">'.$select.'</td>
																			<td class=""><input type="text" name="description[]" class="form-control description"></td>
																			<td class=""><input type="text" name="quantity[]" class="form-control numeric calculate quantity" data-quantity="0" value="'.$item->quantity.'"></td>
																			<td class=""><input type="text" name="price[]" class="form-control numeric-with-point calculate price" value="'.$item->price.'"></td>
																			<td class=""><input type="text" name="discount[]" class="form-control numeric-with-point discount calculate" value="'.$item->discount.'"></td>
																			<td class=""><input type="text" name="tax_amount[]" class="form-control numeric-with-point tax_amount calculate" value="'.$item->tax_amount.'"></td>
																			<td class=""><input type="text" name="amount[]" class="form-control numeric-with-point calculate amount" readonly value="'.$item->amount.'"></td>
																			<td><a href="javascript:void(0);" class="remove-item" data-itemId="'.$item->itemId.'" title="Eliminar"><i class="ti-trash"></i></a></td>
																		</tr>';
																	echo $print;
																	}
																}
