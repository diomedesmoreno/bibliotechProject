				...
				<div class="col-md-12 p-t-10">
					<div class="row form-group">
						...
						<div class="col-md-7 alpha">
							<?php echo form_dropdown('personId', $this->people, set_value('personId', 0), "id='personId' class='form-control select2'");?>
								...
								<tbody>
									<tr>
										<td>
											...
											<?php echo form_dropdown_data('bookId[]', $this->books_all, set_value('bookId', 0), "id='bookId' class='form-control bookId select2'");?>
										</td>
										<td>
