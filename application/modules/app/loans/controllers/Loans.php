...
class Loans extends APP_Controller
{
	public function __construct()
	{
		...
		$this->people 	= $this->students_model->get_all_students($this->schoolId);
		$this->books	= $this->books_model->get_all_book();
		$this->books_all	= $this->books_model->get_all_books();
		// print_d($this->people);
		// print_d($this->books);
	...
	public function insert()
	{
		...
		else
		{
			$data = array(
				...
				'person_typeId'     => 1, //$this->input->post('person_typeId'),
