<div class="modal-dialog modal-lg" id="calendar-event" role="document">
	<div class="modal-content">
		<div class="modal-header">
			<h5 class="modal-title" id="myModalLabel"><i class="ti-plus p-r-7"></i>Editar Evento <span class="event-title"></span></h5>
			<a href="javascript:void(0);" class="close" data-dismiss="modal" aria-hidden="true"><i class="icon-close"></i></a>
		</div>
		<div class="modal-body">
			<form role="form" id="event-form" method="post" action="<?php echo base_url('calendar/update_event/'.$eventId);?>" class="form" onsubmit="return false;">
