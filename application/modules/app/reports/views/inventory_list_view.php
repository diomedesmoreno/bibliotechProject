                    ...
                    <div class="page-header-title">
                        ...
                        <div>
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"><a href="javascript:void(0);">Lista de Inventario</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="input-group input-group-button">
                                        <input type="text" class="form-control add_task_todo"
                                    ...
                                    <div class="new-task">
                                        <div class="to-do-list">
                                            ...
                                            <div class="f-right">
                                                <a href="#!" class="delete_todolist"><i
                        ...
                        <div class="col-md-12 col-xl-4">
                            <div class="card widget-chat-box">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="media">
                                        <img class="d-flex mr-3 img-circle img-60 img-thumbnail"
                                            src="<?php echo base_url();?>assets/template/app/default/assets/images/user-card/img-round1.jpg"
